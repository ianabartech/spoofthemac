...
#https://github.com/ianabartech                                          

# Note that you can improve this code by adding functionality.

# Make sure to use this code as a learning tool but anyone can use this.
...
# You can change all the Mac Address in the list and also add to them.
# Use 12 valid hexadecimal values only!
# If the can't change the MAC address, try changing the second character either 2 | 6 | A | E,
...
mac_to_change_to = ["0E1122334455", "0A69420DEAD8","02143C0FFEE0", "066DECADE420", "0AC0CAC01A00", "02FEED7HED06", "0EC0DEAD1111", "0DEC0DE691111", "0DEDE6942069"]
